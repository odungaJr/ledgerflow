...
def test_search_filters_by_description_substring(client, db_session):
...
def test_date_range_filters(client, db_session):
    account = _make_account(db_session)
...
def test_txn_type_filter(client, db_session):
    account = _make_account(db_session)
